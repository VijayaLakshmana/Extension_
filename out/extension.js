...
function activate(context) {
    ...
    const sidebarProvider = new sidebarView_1.SidebarViewProvider(context.extensionUri);
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.populateInputField', () => {
